...
HangarXPLOR.DrawUI = function()
{
  ...
  $('.sidenav').append(HangarXPLOR.Button('Export pledges JSON', 'exportbuttonjson js-export-hangar', HangarXPLOR._callbacks.ExportHangarJSON));
  $('.sidenav').append(HangarXPLOR.Button('Export pledges CSV', 'exportbuttoncsv js-export-hangar', HangarXPLOR._callbacks.ExportHangarCSV));
